...
public class Kmeans {
    ...
    public static int attrNum = 10;

    //public static String strModelFile = "/Users/Leo/hadoop-2.6.0/kmeans/mr_centroids";
    public static String strModelFile = "/home/hadoop/kmeans_files/mr_centroids";
   ...
   */
    ...
    public static class Reduce extends MapReduceBase implements
        ...
        public void reduce(IntWritable key, Iterator<ClusterWritable> values,
            ...
            System.out.println("The key = " + key.toString() + " has members = " + numMovies + " simil = " + simArrl.get(candidate));
